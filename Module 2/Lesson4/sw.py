# 15/01/2023
# добавили движение по оси Х и условия победы
from tkinter import *
import random
...
background = PhotoImage(file=r"/Module 1/Lesson4/bg_2.png")
...
class Knight:
    def __init__(self):
        ...
        self.x = 150
        self.y = 350
        self.photo = PhotoImage(file=r"/Module 1/Lesson4/knight.png")
        self.v2 = 0
...
class Dragon:
    def __init__(self):
        ...
        self.photo = PhotoImage(file=r"/Module 1/Lesson4/dragon.png")
